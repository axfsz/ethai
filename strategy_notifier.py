    ...
    test_orders = [
        {
            ...
            "投资金额": 1000,
            "杠杆": 3,
            "策略分析": "长线看多信号(4H与1H共振):\n4H级别出现买入结构，止损参考位: 3180.00。\n1H级别出现买入结构，入场点参考: 3210.00。\n策略: 等待价格回调至入场点附近买入，严格止损，盈亏比: 4.00:1。"
        },
        {
            "策略名称": "ETH缠论短线空单",
            "方向": "SELL",
            ...
            "投资金额": 1000,
            "杠杆": 3,
            "策略分析": "短线看空信号(1H+15M+5M共振):\n1H、15M、5M均出现卖出结构，入场点: 3192.00，止损: 3202.00。\n策略: 快进快出，盈亏比: 3.20:1。"
        }
    ]
    save_strategy(test_orders)
    return "测试订单已推送（盈亏比大于3:1）。"
    # 测试有策略的通知
